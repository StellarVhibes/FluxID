...
## 8. FluxID-Specific Notes 🏊🆔

FluxID uses Soroban to store and retrieve liquidity scores. Key patterns:

- **Score Storage:** Map wallet addresses to score values
- **Authorization:** Only designated oracles can update scores
- **Query Interface:** External apps (like IntentRemit) can query scores
